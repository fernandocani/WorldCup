...
class CKMatches {
    ...
    class func fetch() async -> Result<[CKMatchesEntity], WCError> {
        ...
        let query = CKQuery(recordType: RecordTypes.matches.title, predicate: predicate)
...
enum MatchesConstructor: CaseIterable {
    ...
    var homeTeam: String {
        ...
        case .match49: return "1A"
        case .match50: return "1C"
        case .match51: return "1B"
        case .match52: return "1D"
        case .match53: return "1E"
        case .match54: return "1G"
        case .match55: return "1F"
        case .match56: return "1H"
    ...
    var awayTeam: String {
        ...
        case .match49: return "2B"
        case .match50: return "2D"
        case .match51: return "2A"
        case .match52: return "2C"
        case .match53: return "2F"
        case .match54: return "2H"
        case .match55: return "2E"
        case .match56: return "2G"
